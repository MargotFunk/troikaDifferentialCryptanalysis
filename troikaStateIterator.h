...
class TroikaColumns : public ColumnPosition 
{
    public:
        ...
        unsigned int parity;
        /** Index of the component of the parity bare state (see Section 5.3) 
...
/** This class is used to : 
  ...
  *    Appendix E.3 Forward in kernel extension and forwardInKernelExtension.h) 
  * 2) form all the in-kernel states compatible with a given mixed state 
  *    (see Section 5.1 Generating |K|-trail cores).
  * 3) form all the Troika states compatible with a given mixed state 
...
class TroikaStateIterator
{
    public: 
        ...
        /** This attribute is only used when the TroikaStateIterator is
          ...
          * of components of the state (see Section 5.3). 
          */

...
/* 
   ...
   parity profile |K|K| up to some weight (see Appendix D).
...
/** Iterator to generate the trit-activity patterns of the states C and D.
  ...
  * These 5 cases are described in Algorithm 2 of Appendix D.1. 
  *
  */
...
/** This class is used during the traversal of the ActiveStatesCAndDIterator.
  ...
  * tree traversal. (see Algorithm 3 of Appendix D.2). 
